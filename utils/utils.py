...
def jsonCombFileToCSV(path):
    ...
    For more information about the content check the file weak_labeling_snorkel_xgboost.utils.working_with_results.py.
...
def LFCombAnalysis(path):
    ...
    """
    res = {'max_value': [0.0] * 3,
           'num_of_combinations': [0]*3,
           'concept_occurrence_label': [0] * 3,
           'name_exact': [0] * 3,
           'name_exact_lowercase': [0] * 3,
           'name_exact_lowercase_no_punc': [0] * 3,
           'name_exact_lowercase_tokens_no_punc': [0] * 3,
           'synonyms_exact': [0] * 3,
           'synonyms_lowercase': [0] * 3,
           'synonyms_lowercase_no_punc': [0] * 3,
           'synonyms_lowercase_tokens_no_punc': [0] * 3,
           }
    ...
    modelMetrics = list(data.columns)[-3:]
