...
settings_file = open("/home/chatzothomas/projects/models/weak_labeling_snorkel/src/weak_labeling/settings.yaml")
...
for year in range(settings["firstYear"], settings["lastYear"] + 1, 1):
    ...
    folderName = f"snorkel_results_{year}_0_2_6"
    ...
    copy(
        "/home/chatzothomas/projects/models/weak_labeling_snorkel/src/weak_labeling/settings.yaml",
        workingPath)
