...
from weak_labeling_snorkel_xgboost.snorkel_labeling.utils import getLFname
from weak_labeling_snorkel_xgboost.utils.utils import save_evaluation_report, printTimestamp
from weak_labeling_snorkel_xgboost.snorkel_labeling.LFs import (
...
def loadSynonyms(path):
    ...
    for descriptor in data.get("documents"):
